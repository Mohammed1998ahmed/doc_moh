...
import 'package:doctor/consultation/details/Medical.dart';
import 'package:doctor/consultation/details/cubit/postreply_cubit.dart';
import 'package:doctor/consultation/details/treatment.dart';
import 'package:doctor/consultation/details/vaccination.dart';
...
class DetailsHospitel extends StatelessWidget {
  DetailsHospitel(
      ...
      required this.Consutition_ID});
  final GetConsultationModel? getConsultationModel;
  final int indexID;
  final int Consutition_ID;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => PostreplyCubit(),
      child: BlocConsumer<PostreplyCubit, PostreplyState>(
        listener: (context, state) {
          if (State is PostreplySesseccfluy) {
        ...
        builder: (context, state) {
          ...
          final cubit = PostreplyCubit.getObject(context);
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                getConsultationModel!.consultation![indexID].replyContent ==
                        null
                    ? TextButton(
                        onPressed: () {
                          showDialog(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Container(
                              child: text(title: "gender:", color: Color4)),
                          SizedBox(
                            width: 15,
                          ),
                          Container(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Center(
                                child:
                                    text(title: "vaccination", color: Color3)),
                          ),
                        ),
                        GestureDetector(
                          onTap: () {
